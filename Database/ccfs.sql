...
CREATE TABLE `enstudent` (
  `enid` int(90) NOT NULL,
  `IDno` int(11) DEFAULT NULL,
...
ALTER TABLE `attendance`
  ...
  ADD KEY `studid` (`IDno`,`yearid`) USING BTREE,
  ADD KEY `idyear` (`yearid`) USING BTREE;
...
ALTER TABLE `curriculum`
  ...
  ADD KEY `idyear` (`yearid`) USING BTREE,
  ADD KEY `curname` (`curname`);

--
-- Indexes for table `curstudent`
--
ALTER TABLE `curstudent`
  ADD PRIMARY KEY (`studentid`),
  ADD UNIQUE KEY `IDno_2` (`IDno`),
  ADD KEY `gradlvl_idx` (`gradelvl`),
  ADD KEY `yearID_idx` (`yearid`),
  ADD KEY `enrID_idx` (`enrID`),
  ADD KEY `IDno` (`IDno`);

--
-- Indexes for table `enstudent`
--
ALTER TABLE `enstudent`
  ADD PRIMARY KEY (`enid`),
  ADD KEY `studFname` (`GivenName`),
  ADD KEY `studLname` (`SurName`),
  ADD KEY `gradelvl` (`gradelvl`),
  ADD KEY `YearID_idx` (`yearid`),
  ADD KEY `studIDno_idx` (`IDno`);

--
-- Indexes for table `feestudent`
--
ALTER TABLE `feestudent`
  ADD PRIMARY KEY (`feestID`),
  ADD KEY `estudyID` (`IDno`),
  ADD KEY `theyear_idx` (`yearid`);
...
ALTER TABLE `grades`
  ...
  ADD KEY `studid_idx` (`IDno`),
  ADD KEY `suID` (`subjID`),
  ADD KEY `yid` (`yearid`) USING BTREE;
...
ALTER TABLE `payment`
  ...
  ADD KEY `yearid` (`yearid`),
  ADD KEY `feestID` (`feeestID`) USING BTREE;

--
-- Indexes for table `schoolfees`
--
ALTER TABLE `schoolfees`
  ADD PRIMARY KEY (`scfeeid`),
...
ALTER TABLE `schoolyear`
  ...
  ADD KEY `yearstart` (`yearstart`),
  ADD KEY `yearend` (`yearend`);
...
--
ALTER TABLE `assessment`
  MODIFY `assessID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
--
-- AUTO_INCREMENT for table `attendance`
--
ALTER TABLE `attendance`
  MODIFY `attid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=218;
--
-- AUTO_INCREMENT for table `checklist`
--
ALTER TABLE `checklist`
  MODIFY `checkid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=204;
--
-- AUTO_INCREMENT for table `curriculum`
--
ALTER TABLE `curriculum`
  MODIFY `curid` int(45) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
-- AUTO_INCREMENT for table `curstudent`
--
ALTER TABLE `curstudent`
  MODIFY `studentid` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID FOR TABLE', AUTO_INCREMENT=43;
--
-- AUTO_INCREMENT for table `enstudent`
--
ALTER TABLE `enstudent`
  MODIFY `enid` int(90) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
--
-- AUTO_INCREMENT for table `feestudent`
--
ALTER TABLE `feestudent`
  MODIFY `feestID` int(40) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `grades`
--
ALTER TABLE `grades`
  MODIFY `gradeid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
--
-- AUTO_INCREMENT for table `payment`
--
ALTER TABLE `payment`
  MODIFY `payid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
--
-- AUTO_INCREMENT for table `schoolfees`
--
ALTER TABLE `schoolfees`
  MODIFY `scfeeid` int(40) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `subject`
  MODIFY `subjID` int(90) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
--
