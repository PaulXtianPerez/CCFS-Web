...
$select_query = "SELECT * FROM `checklist` WHERE (checkdesc IS NULL AND valuedesc IS NULL) AND yearID IN (SELECT yearid from schoolyear WHERE scstatus='ACTIVE') ORDER BY competencyvalues";
$output = '';
