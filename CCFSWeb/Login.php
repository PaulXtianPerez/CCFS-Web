...
<head>
	...
	<link rel="icon" href="dist/img/CCFS_logo.png" type="image/icon type">
	<meta charset="UTF-8">
		...
		<div class="container-login100">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50 animated animatedFadeInUp fadeInUp">
				<form class="login100-form validate-form">
					<img src="dist/img/CCFS_Logo.png" alt="CCFS Logo" id="ccfs_logo" class="animated animatedFadeInUp fadeInUp" >
					...
					<div class="wrap-input100 rs1 validate-input" data-validate="Password is required">
						<input class="input100" id="enterButton" type="password" name="pass" placeholder="Password">
						<span class="focus-input100-1"></span>
						<span class="focus-input100-2"></span>
					</div>

					<div class="container-login100-form-btn m-t-20">
						<button class="login100-form-btn"><a href="index.php" class="login100-form-btn">
							Login
						</a></button>
					</div>
				</form>
